...
import com.K1ll4a.Server.tools.PasswordHashing;
import com.K1ll4a.global.facility.*;
import com.K1ll4a.Server.managers.SocketServer;
import com.K1ll4a.global.facility.Mclass;
import com.K1ll4a.global.facility.Mclass.UnitOfMeasure;
import com.K1ll4a.global.facility.Mclass.*;
...
import static com.K1ll4a.Server.managers.SocketServer.log;
...
public class DatabaseRuler {
    ...
    private String DB_PASSWORD = "tWTEYJEdnfriXB4Y";
    private String URL = "jdbc:postgresql://" + DB_HOST + "/" + DB_NAME;
    private final String ADD_MCLASS =
            "insert into mclass (name,x_coordinate , y_coordinate ,creation_date,price,manufactureCost, unitOfMeasure , " +
    ...
    public Mclass getLastMclass() throws SQLException {
        ...
        if (resultSet.next()){
            ...
            float x = resultSet.getFloat("x_coordinate");
            float y = resultSet.getFloat("y_coordinate");
            Mclass.Coordinates coordinates = new Mclass.Coordinates(x, y);
            String creationDate = resultSet.getString("creation_date");
            Double price = resultSet.getDouble("price");
            float manufactureCost = resultSet.getFloat("manufactureCost");
            ...
            Mclass.Organization organization = new Mclass.Organization(OrgId, org_name, org_fullname, organizationType);
            int userId = resultSet.getInt("user_id");
            String login = resultSet.getString("login");
    ...
    public boolean insertUser(String login, String password, String salt) {
        try {
    ...
    public void insertMclass(Mclass mclass,String login) throws SQLException{
        try {
            ...
            int userId = mclass.getUser_id();
            preparedStatement.setString(1,name);
            preparedStatement.setFloat(2,x);
            preparedStatement.setFloat(3,y);
            preparedStatement.setString(4,creationDate);
            preparedStatement.setDouble(5,price);
            preparedStatement.setFloat(6,manufactureCost);
            preparedStatement.setString(7,unitOfMeasure);
